...
const student = Array(3);
student.fill(new Student("Itay", 25, false, [100, 90, 80]), 0, 1);
student.fill(new Student("Yam", 30, false, [90, 80, 70]), 1, 2);
student.fill(new Student("Yaron", 35, false, [80, 70, 60]), 2);
console.log(student);
